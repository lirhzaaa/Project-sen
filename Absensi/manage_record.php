...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($action == 'edit') {
        ...
        if ($id && $user_id && $datetime && $attendance !== '') {
            try {
                $stmt = $pdo->prepare("UPDATE attendance_records SET user_id = :user_id, datetime = :datetime, attendance = :attendance, check_type = :check_type WHERE id = :id");
